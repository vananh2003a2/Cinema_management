...
<div class="header">
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-0">
            <div class="container-fluid">
                <a class="navbar-brand p-0" href="trangchu"><img class="height-header img-fluid" src='<c:url value="/template/customer/img/logo/sdasd40.png"/>'"
                        alt="no-logo" class=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-center align-items-center">
                        <li class="nav-item">
                            <a class="m-0 nav-link active fw-normal text-secondary h5 px-3" aria-current="page" href="trang-chu">TRANG CHỦ</a>
                        </li>
                        <li class="nav-item">
                            <a class="m-0 nav-link fw-normal text-secondary h5 px-3" href="./timeCinema.html">LỊCH CHIẾU</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-normal text-secondary h5 px-3 m-0" href="contact.html">LIÊN HỆ</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu m-0 p-0 shadow-sm" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="phimSapChieu.html">Phim đang chiếu</a></li>
                                <li><a class="dropdown-item" href="phimSapChieu.html">Phim sắp chiếu</a></li>
                            </ul>
                        </li>
                    </ul>
                    <form class="d-flex">
